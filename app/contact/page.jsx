  ...
  return (
    <section className="container mx-auto mt-8">
      ...
      <div className="bg-dark p-2 rounded-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div className="bg-secondary p-4 rounded-lg shadow-inner shadow-dark">
          <h3 className="text-xl mb-2">Whatsapp</h3>
          <a
            href="https://wa.me/5544988150190"
            className="text-green-400 bg-transparent hover:bg-primary border-green-400 border-2 rounded-md p-1"
          >
            (44) 988150190
          </a>
        </div>
        <div className="bg-secondary p-4 rounded-lg shadow-inner shadow-dark">
          <h3 className="text-xl mb-2">GitHub</h3>
          <a
            href="https://github.com/TofuVoador"
            className="text-gray-400 bg-transparent hover:bg-primary border-gray-400 border-2 rounded-md p-1"
          >
            @TofuVoador
          </a>
        </div>
